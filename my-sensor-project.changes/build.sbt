import cloudflow.sbt.DockerImageName
import sbt._
import sbt.Keys._
...
cloudflowDockerRegistry := Some("us.gcr.io")
cloudflowDockerRepository := Some("cloudflow-1023b")
cloudflowDockerImageName := Some(DockerImageName("my-sensor-project", "2"))
